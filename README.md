...
```sh
g++ -I ./framework/include -I ./concrete/include ./concrete/src/Board.cpp ./concrete/src/Level.cpp ./concrete/src/Snake.cpp ./concrete/src/Game.cpp ./concrete/src/Level.cpp ./concrete/src/LevelScore.cpp ./concrete/src/GameScore.cpp ./snake_main.cpp -o snake_game
```
